...
export default function EditRoom() {
    const { room } = usePage<Props>().props;
    
    const { data, setData, put, processing, errors } = useForm({
        name: room.name || '',
        code: room.code || '',
        description: room.description || '',
        is_active: room.is_active as boolean,
        prefix: room.prefix || 'R',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('antrian.rooms.update', room.id), {
            onSuccess: () => {
            ...
            onError: (errors) => {
                ...
                if (Object.keys(errors).length > 0) {
                    ...
                    toast.error(typeof firstError === 'string' ? firstError : 'Gagal memperbarui ruangan. Periksa kembali data yang dimasukkan.');
                } else {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/antrian/rooms/${room.id}/edit`,
        },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4">
                <div className="mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Perbarui data ruangan {room.name}
                        </p>
                    </div>
                    <Button
                        variant="outline"
                ...
                <Card className="w-full">
                    <CardHeader>
                        <CardTitle>Form Edit Ruangan</CardTitle>
                        <CardDescription>
